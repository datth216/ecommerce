    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>Simple Shop</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Simple Shop Office
               Email:datwin0143@gmail.com <br>
               Mob: 0901326841 <br>
               Phu Tho Hoa, Tan Phu, TPHCM <br>
            </pre>
            </td>
        </tr>
        ...
        <tbody>
            @foreach ($orderItem as $item)
                <tr class="font">
                    ...
                    <td align="center">{{ $item->qty * $item->qty }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
