                                            ...
                                            <div class="accordion-heading">
                                                @if(session()->get('language') == 'vn')
                                                    <a href="#collapse{{$category->id}}" data-toggle="collapse"
                                                       class="accordion-toggle collapsed">{{$category->category_name_vn}}</a>
                                                @else
                                                    <a href="#collapse{{$category->id}}" data-toggle="collapse"
                                            ...
                                            <div class="accordion-body collapse" id="collapse{{$category->id}}"
                                                ...
                                                <div class="accordion-inner">
                                                    @foreach($category->categoryChildren as $categoryChild)
                                                        <ul>
                                                            <li>
                                                                <a href="{{url('/categories/product/' . $categoryChild->id. '/' .  $categoryChild->category_slug_en)}}">{{$categoryChild->category_name_en}}</a>
                                                            </li>
                                                        </ul>
                                                    @endforeach
                                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-sm-6 col-md-4 text-right">
                            <div class="pagination-container">
                                <ul class="list-inline list-unstyled">
                                    {{$tagProduct->links('pagination::bootstrap-4')}}
                                </ul>
                                <!-- /.list-inline -->
                            </div>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="product-info text-left">
                                                        ...
                                                        <div class="product-price">
                                                            @if($product->discount_price == NULL ||$product->discount_price == $product->selling_price)
                                                                <span
                                                                    class="price"> {{number_format($product->selling_price, 0, '', '.')}}đ </span>
                                                            @else
                                                                <span
                                                                    class="price"> {{number_format($product->discount_price, 0, '', '.')}}đ</span>
                                                                <span
                                                                    class="price-before-discount">{{number_format($product->selling_price, 0, '', '.')}}đ</span>
                                                            @endif
                                                        </div>
                                                        <!-- /.product-price -->
                                                    ...
                                                    <div class="col col-sm-8 col-lg-8">
                                                        <div class="product-info">
                                                            ...
                                                            <div class="product-price">
                                                                ...
                                                                @if($product->discount_price == NULL ||$product->discount_price == $product->selling_price)
                                                                    <span
                                                                        class="price"> {{number_format($product->selling_price, 0, '', '.')}} </span>
                                                                @else
                                                                    <span
                                                                        class="price"> {{number_format($product->discount_price, 0, '', '.')}} </span>
                                                                    <span
                                                                        class="price-before-discount">{{number_format($product->selling_price, 0, '', '.')}}</span>
                                                                @endif
